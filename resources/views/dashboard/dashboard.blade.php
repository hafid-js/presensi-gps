                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            <div class="iconpresence">
                               ...
                               @endphp
                               <img class="img-fluid" style="border-radius: 8px;" height="70" width="70" src="{{ url($path) }}" alt="">
                               @else
...
<div class="" id="rekappresence">
    <h4>Rekap Presensi {{ $namabulan[$bulanini] }} Tahun {{ $tahunini }}</h4>
    <div class="row">
        <div class="col-3">
            <div class="card">
                            ...
                            <div class="historicontent">
                                ...
                                <div class="datapresensi">
                                    ...
                                    <div id="keterangan"
                                        ...
                                        @endphp
                                        <span class="danger">Terlambat {{ $jmlterlambat }} ({{ $jmlterlambatdesimal }})</span>
                                        @else
